"""
Django settings for brother_reminder project.
...
ROOT_URLCONF = 'brother_reminder.urls'
...
WSGI_APPLICATION = 'brother_reminder.wsgi.application'
...
# For development/testing without actual email sending, uncomment below:
